function traerReporteStatus(){
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/report-status",
        type:"GET",
        datatype:"JSON",
...
function traerReportesFechas(){
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/report-dates/{dateOne}/{dateTwo}",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta)
...
function traerReportesClientes(){
    ...
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/report-clients",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta)
