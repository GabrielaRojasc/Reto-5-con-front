...
function getReservaciones (){
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function postReservaciones(){
    ...
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/save",
        type:"POST",
        datatype:"JSON",
...
function putReservaciones(idDesdeBoton){
    ...
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteReservaciones(data){
    ...
    $.ajax({
        url:"http://129.151.112.18:8090/api/Reservation/"+data,
        type:"DELETE",
        datatype:"JSON",
...
function getClient_Reservation(){
    $.ajax({
        url:"http://129.151.112.18:8090/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function getOrtesis_Reservation(){
    $.ajax({
        url:"http://129.151.112.18:8090/api/Ortesis/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
